...
module.exports = {
  ...
  create(context) {
    return {
      'JSXAttribute[name.name="aria-labelledby"]:matches([value.type="Literal"],[value.type="JSXExpressionContainer"][value.expression.type="TemplateLiteral"]:has(:matches(TemplateElement[value.raw]:not([value.raw=/^(| )$/]),Literal)))':
        (node) => {
          context.report({
            node,
