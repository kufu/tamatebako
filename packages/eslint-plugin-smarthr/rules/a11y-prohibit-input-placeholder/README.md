...
仮にplaceholderに**どんな値を入力してほしいか（例: 半角で10文字以内）**が設定されている場合、現在入力されている値が正しい値かどうかをユーザーが判断できなくなります。
...
しかく濃淡の判断がしづらい視覚特性をもつユーザーの場合、placeholder属性が設定されている場合と実際に値が入力されている場合を判断することが出来ない・困難な場合もあります。
