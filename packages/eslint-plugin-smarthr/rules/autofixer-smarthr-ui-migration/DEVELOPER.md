...
- rules/autofixer-smarthr-ui-migration/versions/v98-to-v99/REFERENCE.md（実装パターンの詳細説明）
- rules/autofixer-smarthr-ui-migration/versions/v98-to-v99/index.js（実装例）
- rules/autofixer-smarthr-ui-migration/versions/v98-to-v99/README.md（ユーザー向け移行ガイド）
- rules/autofixer-smarthr-ui-migration/versions/v98-to-v99/test.js（テストケース）
...
**最新version:** [v98-to-v99/REFERENCE.md](./versions/v98-to-v99/REFERENCE.md)
