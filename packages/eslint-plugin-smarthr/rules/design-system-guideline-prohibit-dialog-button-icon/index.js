...
module.exports = {
  ...
  create(context) {
    return {
      'JSXOpeningElement[name.name=/Dialog$/] JSXAttribute[name.name=/^(actionText|submitLabel|(submit|close|back)Button)$/] JSXExpressionContainer JSXOpeningElement[name.name=/Icon$/]':
        (node) => {
          context.report({
            node,
