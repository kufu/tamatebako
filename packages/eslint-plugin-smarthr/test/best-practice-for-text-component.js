...
ruleTester.run('best-practice-for-text-component', rule, {
  ...
  invalid: [
    ...
    // パターン1-2: as属性のみ
    { code: `<Text as="p">content</Text>`, errors: [{ message: errorAsOnly('p') }] },
    { code: `<Text as="div">content</Text>`, errors: [{ message: errorAsOnly('div') }] },

    // パターン1-3: classNameのみ（変換不可能なクラスのみ）
    { code: `<Text className="custom">content</Text>`, errors: [{ message: errorUnnecessaryClassName('custom') }] },
    { code: `<Text className="custom-class another-class">text</Text>`, errors: [{ message: errorUnnecessaryClassName('custom-class another-class') }] },

    // パターン1-4: className + as（変換不可能なクラスのみ）
    { code: `<Text as="p" className="custom">content</Text>`, errors: [{ message: errorUnnecessaryAsClassName('p') }] },

    // パターン2-1: classNameのみ（すべて変換可能）
    { code: `<Text className="shr-text-sm">text</Text>`, errors: [{ message: errorConvertibleShr('size="S"', 'shr-text-sm') }] },
    { code: `<Text className="shr-text-sm shr-font-bold">text</Text>`, errors: [{ message: errorConvertibleShr('size="S" weight="bold"', 'shr-text-sm, shr-font-bold') }] },
    { code: `<Text className="shr-text-lg shr-font-bold shr-text-grey">text</Text>`, errors: [{ message: errorConvertibleShr('size="L" weight="bold" color="TEXT_GREY"', 'shr-text-lg, shr-font-bold, shr-text-grey') }] },

    // パターン2-2: className + as（すべて変換可能）
    { code: `<Text as="p" className="shr-text-sm">text</Text>`, errors: [{ message: errorConvertibleShr('size="S"', 'shr-text-sm', 'p') }] },
    { code: `<Text as="p" className="shr-text-sm shr-font-bold">text</Text>`, errors: [{ message: errorConvertibleShr('size="S" weight="bold"', 'shr-text-sm, shr-font-bold', 'p') }] },

    // パターン2-3: 一部のみ変換可能
    { code: `<Text className="shr-text-sm custom-class">text</Text>`, errors: [{ message: errorConvertibleShr('size="S" className="custom-class"', 'shr-text-sm') }] },
    { code: `<Text as="p" className="shr-text-sm custom-class">text</Text>`, errors: [{ message: errorConvertibleShr('size="S" className="custom-class"', 'shr-text-sm', 'p') }] },
    { code: `<Text className="shr-text-lg shr-font-bold custom-one custom-two">text</Text>`, errors: [{ message: errorConvertibleShr('size="L" weight="bold" className="custom-one custom-two"', 'shr-text-lg, shr-font-bold') }] },
    ...
    // 追加テスト: 各クラスの網羅性確認
    { code: `<Text className="shr-text-2xs">text</Text>`, errors: [{ message: errorConvertibleShr('size="XXS"', 'shr-text-2xs') }] },
    { code: `<Text className="shr-text-2xl">text</Text>`, errors: [{ message: errorConvertibleShr('size="XXL"', 'shr-text-2xl') }] },
    { code: `<Text className="shr-leading-none">text</Text>`, errors: [{ message: errorConvertibleShr('leading="NONE"', 'shr-leading-none') }] },
    { code: `<Text className="shr-text-white">text</Text>`, errors: [{ message: errorConvertibleShr('color="TEXT_WHITE"', 'shr-text-white') }] },
    { code: `<Text className="shr-text-color-inherit">text</Text>`, errors: [{ message: errorConvertibleShr('color="inherit"', 'shr-text-color-inherit') }] },
  ]
})
