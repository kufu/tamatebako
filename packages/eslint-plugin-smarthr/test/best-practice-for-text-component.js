...
const errorUnnecessaryClassName = (
  className,
...
const errorUnnecessaryAsClassName = (
  tag,
...
const errorConvertibleShr = (
  suggestion,
  convertible,
) => `classNameで指定されたshr-プレフィックスのクラスは、Textコンポーネントの属性に置き換えてください。
 - 詳細: https://github.com/kufu/tamatebako/tree/master/packages/eslint-plugin-smarthr/rules/best-practice-for-text-component
 - 推奨: <Text ${suggestion}>
 - 変換可能なクラス: ${convertible}
 - shr-プレフィックスのクラスをTextの属性に置き換えることで、型安全性が向上し、意図がより明確になります`

const errorConvertibleShrWithSpread = (
  convertible,
) => `classNameで指定されたshr-プレフィックスのクラスは、Textコンポーネントの属性に置き換えてください。
 - 詳細: https://github.com/kufu/tamatebako/tree/master/packages/eslint-plugin-smarthr/rules/best-practice-for-text-component
 - 変換可能なクラス: ${convertible}
...
ruleTester.run('best-practice-for-text-component', rule, {
  ...
  invalid: [
    ...
    {
      code: `<Text key="item-1">content</Text>`,
      output: `<span key="item-1">content</span>`,
      errors: [{ message: errorUnnecessaryClassName('') }],
    },
    ...
    {
      code: `<Text as="p" key="item-1">content</Text>`,
      output: `<p key="item-1">content</p>`,
      errors: [{ message: errorAsOnly('p') }],
    },

    // パターン1-3: classNameのみ（変換不可能なクラスのみ）
    {
      code: `<Text className="custom">content</Text>`,
      output: `<span className="custom">content</span>`,
      errors: [{ message: errorUnnecessaryClassName('custom') }],
    },

    // パターン1-3b: className + key属性（key属性は保持される）
    {
      code: `<Text className="custom" key="item-1">content</Text>`,
      output: `<span className="custom" key="item-1">content</span>`,
      errors: [{ message: errorUnnecessaryClassName('custom') }],
    },
    ...
    // パターン1-4: className + as（変換不可能なクラスのみ）
    {
      ...
      output: `<p className="custom">content</p>`,
      errors: [{ message: errorUnnecessaryAsClassName('p') }],
    },

    // パターン2-1: classNameのみ（すべて変換可能）
    {
      code: `<Text className="shr-text-sm">text</Text>`,
      output: `<Text size="S">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S"', 'shr-text-sm') }],
    },
    {
      code: `<Text className="shr-text-sm shr-font-bold">text</Text>`,
      output: `<Text size="S" weight="bold">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S" weight="bold"', 'shr-text-sm, shr-font-bold') }],
    },
    {
      code: `<Text className="shr-text-lg shr-font-bold shr-text-grey">text</Text>`,
      output: `<Text size="L" weight="bold" color="TEXT_GREY">text</Text>`,
      errors: [
        { message: errorConvertibleShr('size="L" weight="bold" color="TEXT_GREY"', 'shr-text-lg, shr-font-bold, shr-text-grey') },
      ],
    },
    ...
    // パターン2-2: className + as（すべて変換可能）
    {
      ...
      output: `<Text as="p" size="S">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S"', 'shr-text-sm') }],
    },
    {
      code: `<Text as="p" className="shr-text-sm shr-font-bold">text</Text>`,
      output: `<Text as="p" size="S" weight="bold">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S" weight="bold"', 'shr-text-sm, shr-font-bold') }],
    },
    ...
    // パターン2-3: 一部のみ変換可能
    {
      ...
      output: `<Text size="S" className="custom-class">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S" className="custom-class"', 'shr-text-sm') }],
    },
    {
      code: `<Text as="p" className="shr-text-sm custom-class">text</Text>`,
      output: `<Text as="p" size="S" className="custom-class">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S" className="custom-class"', 'shr-text-sm') }],
    },
    {
      code: `<Text className="shr-text-lg shr-font-bold custom-one custom-two">text</Text>`,
      output: `<Text size="L" weight="bold" className="custom-one custom-two">text</Text>`,
      errors: [
        {
          message: errorConvertibleShr('size="L" weight="bold" className="custom-one custom-two"', 'shr-text-lg, shr-font-bold'),
        },
      ],
    },
    ...
    {
      code: `<Text className="shr-w-[10rem]">text</Text>`,
      output: `<span className="shr-w-[10rem]">text</span>`,
      errors: [{ message: errorUnnecessaryClassName('shr-w-[10rem]') }],
    },
    {
      code: `<Text className="shr-inline-block shr-mr-0.5">text</Text>`,
      output: `<span className="shr-inline-block shr-mr-0.5">text</span>`,
      errors: [{ message: errorUnnecessaryClassName('shr-inline-block shr-mr-0.5') }],
    },
    {
      code: `<Text as="p" className="shr-bg-background shr-block">text</Text>`,
      output: `<p className="shr-bg-background shr-block">text</p>`,
      errors: [{ message: errorUnnecessaryAsClassName('p') }],
    },
    ...
    { code: `<Text size="M" className="shr-text-sm">text</Text>`, errors: [{ message: errorConflictingProps('shr-text-sm') }] },
    {
      ...
      errors: [{ message: errorConflictingProps('shr-font-normal') }],
    },
    {
      code: `<Text size="L" className="shr-text-sm shr-font-bold">text</Text>`,
      errors: [{ message: errorConflictingProps('shr-text-sm, shr-font-bold') }],
    },
    {
      code: `<Text size="M" className="shr-text-sm custom-class">text</Text>`,
      errors: [{ message: errorConflictingProps('shr-text-sm') }],
    },

    // 追加テスト: 未知の属性が保持されることを確認
    {
      code: `<Text className="custom" id="foo">text</Text>`,
      output: `<span className="custom" id="foo">text</span>`,
      errors: [{ message: errorUnnecessaryClassName('custom') }],
    },
    {
      code: `<Text as="p" id="foo" className="shr-text-sm">text</Text>`,
      output: `<Text as="p" size="S" id="foo">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S"', 'shr-text-sm') }],
    },

    // key属性対応テスト（追加のエッジケース）
    {
      code: `<Text key="item-1" className="shr-text-sm">text</Text>`,
      output: `<Text size="S" key="item-1">text</Text>`,
      errors: [{ message: errorConvertibleShr('size="S"', 'shr-text-sm') }],
    },

    // spread attributes + 変換可能なclassName（fixなし、警告のみ）
    {
      code: `<Text {...props} className="shr-text-sm">text</Text>`,
      errors: [{ message: errorConvertibleShrWithSpread('shr-text-sm') }],
    },
    {
      code: `<Text {...props} className="shr-text-sm shr-font-bold">text</Text>`,
      errors: [{ message: errorConvertibleShrWithSpread('shr-text-sm, shr-font-bold') }],
    },
  ],
})
